...
$info = [
    [
        'work_name' => 'Bank specialist',
        'work_date' => 'October 2016 - November 2018',
        'work_descrip' => 'Bank employee, specialized in consumer lending',
    ],
    [
        'work_name' => 'Warehouse auditor Adidas',
        'work_date' => 'December 2018 - November 2019',
        'work_descrip' => 'I worked at the Adidas warehouse. Engaged in the acceptance, shipment and inventory of goods in the warehouse',
    ],
    [
        'work_name' => 'Real Estate Agent',
        'work_date' => 'November 2019 - Current',
        'work_descrip' => 'A real estate specialist. Main tasks: document verification, transaction support, settlement coordination, selection of real estate objects for clients, as well as their sale',
    ],
];
